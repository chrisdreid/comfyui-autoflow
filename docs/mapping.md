...
api = Workflow("workflow.json", object_info="object_info.json", convert_callbacks=random_seed)
```
...
api = Workflow("workflow.json", object_info="object_info.json", convert_callbacks=seed_from_meta)
```
